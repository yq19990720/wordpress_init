 ...
 */
//SMTP配置
define("SMTPHOST","smtp.mailgun.org");//SMTP Host

define("ENCRYPTION","ssl");//Encryption

define("SMTPPROT","465");//SMTP Port

define("SMTPUSERNAME","poster@ipmoore.com");//SMTP Username

define("SMTPPASSWORD","af7e21bf5e334ebfde2981f844fc488c-2ac825a1-7382b24d");//SMTP Password
