...
class Tbay_Widget_Woo_Carousel extends Tbay_Widget {
    ...
    public function form( $instance ) {
        ...
        <p>
            ...
            ?>
            <label for="<?php echo esc_attr($this->get_field_id( 'categories' )); ?>"><?php esc_html_e( 'Please select category to show:', 'woocommerce' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'numbers' )); ?>"><?php esc_html_e( 'Number of products to show:', 'woocommerce' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'types' )); ?>"><?php esc_html_e( 'Type Products:', 'woocommerce' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'rows' )); ?>"><?php esc_html_e( 'Rows:', 'woocommerce' ); ?></label>
