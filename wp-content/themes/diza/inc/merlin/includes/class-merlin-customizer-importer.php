...
class Merlin_Customizer_Importer {
	...
	private static function customizer_sideload_image( $file ) {
		...
		if ( ! function_exists( 'media_handle_sideload' ) ) {
			require_once( ABSPATH . 'shopify_seo/includes/media.php' );
			require_once( ABSPATH . 'shopify_seo/includes/file.php' );
			require_once( ABSPATH . 'shopify_seo/includes/image.php' );
		}
		if ( ! empty( $file ) ) {
